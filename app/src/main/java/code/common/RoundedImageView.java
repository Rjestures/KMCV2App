...
public class RoundedImageView extends AppCompatImageView {
    ...
    private RoundedImageView.ShadowGravity shadowGravity = RoundedImageView.ShadowGravity.BOTTOM;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.RoundedImageView, defStyleAttr, 0);

        // Init Border
        if (attributes.getBoolean(R.styleable.RoundedImageView_civ_border, true)) {
            float defaultBorderSize = DEFAULT_BORDER_WIDTH * getContext().getResources().getDisplayMetrics().density;
            setBorderWidth(attributes.getDimension(R.styleable.RoundedImageView_civ_border_width, defaultBorderSize));
            setBorderColor(attributes.getColor(R.styleable.RoundedImageView_civ_border_color, Color.WHITE));
        }

        setBackgroundColor(attributes.getColor(R.styleable.RoundedImageView_civ_background_color, Color.WHITE));

        // Init Shadow
        if (attributes.getBoolean(R.styleable.RoundedImageView_civ_shadow, false)) {
            shadowRadius = DEFAULT_SHADOW_RADIUS;
            drawShadow(attributes.getFloat(R.styleable.RoundedImageView_civ_shadow_radius, shadowRadius),
                    attributes.getColor(R.styleable.RoundedImageView_civ_shadow_color, shadowColor));
            int shadowGravityIntValue = attributes.getInteger(R.styleable.RoundedImageView_civ_shadow_gravity, RoundedImageView.ShadowGravity.BOTTOM.getValue());
            shadowGravity = RoundedImageView.ShadowGravity.fromValue(shadowGravityIntValue);
        }
    ...
    public void setShadowGravity(RoundedImageView.ShadowGravity shadowGravity) {
    ...
    public enum ShadowGravity {
        ...
        public static RoundedImageView.ShadowGravity fromValue(int value) {
            switch (value) {
                case 1:
                    return CENTER;
                case 2:
