...
public class CheckInActivity extends BaseActivity implements View.OnClickListener {
    ...
    public Boolean locUpdates = false;
    ...
    private void findViewById() {
        ...
        DatabaseController.updateNotEqual(mContentValues, TableDutyChange.tableName,
                TableDutyChange.tableColumn.nurseListId.toString(), "0");*/
    ...
    public void displayView(int position) {
        ...
        switch (position) {
            ...
            case 0:
                fragment = new NurseSelectionFragment();
                break;

            case 1:

                fragment = new NurseSelfieFragment();
                break;

            case 2:

                fragment = new NurseSuccessfullFragment();
                break;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.llLanguage:
                ...
                AppUtils.AlertLanguageConfirmForCheckin(mActivity, getString(R.string.languageAlert), "in");
    ...
    public void onBackPressed() {
        AppUtils.AlertCloseCheckActivity(mActivity, getString(R.string.sureToCancel));
    }
