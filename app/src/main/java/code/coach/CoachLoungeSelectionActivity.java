...
import code.checkIn.NurseSelectionFragment;
import code.checkIn.NurseSelfieFragment;
import code.checkIn.NurseSuccessfullFragment;
...
public class CoachLoungeSelectionActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void findViewById() {
        ...
        tvHeading.setText(AppSettings.getString(AppSettings.name));
    ...
    public void  displayView(int position) {
        ...
        switch (position) {
            ...
            case 0:
                ...
                fragment = new LoungeSelectionFragment();
                break;
